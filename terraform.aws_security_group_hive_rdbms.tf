resource "aws_security_group" "hive_rdbms" {
  name        = "Hive RDBMS Security Group"
  description = "Hive RDBMS Security Group"  # see https://www.stefaanlippens.net/hadoop-3-default-ports.html
  ingress {
    description = "ssh"
    protocol = "tcp"
    from_port = 22
